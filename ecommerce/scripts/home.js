...
const sectionMaisVendidos = document.querySelector("#section-1 .carrousel")
const sectionPromocoes = document.querySelector("#section-2 .carrousel")
const sectionNovidades = document.querySelector("#section-3 .carrousel")
