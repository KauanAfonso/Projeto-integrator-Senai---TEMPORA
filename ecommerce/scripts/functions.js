export function loadProducts(productList, load) {
  ...
  productList.forEach((produto) => {
    ...
    const html = `<swiper-slide class="product-card idprod mySwiper"  id="${produto.codigoProduto}">
        ...
        <div class="product-card-info-container">
          ...
          <div class="stars"><img class='estrelas' src="../imagens/estrelas.png" alt="Estrelas"></div>
